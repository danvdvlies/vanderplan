...
class IncomeTests(TestCase):
    ...
    def test_income_for_month_sums_only_income(self):
        ...
        self.assertEqual(
            services.income_for_month(self.user, self.month), Decimal("2000.00")
        )
    ...
    def test_income_only_counts_its_own_month(self):
        ...
        self.assertEqual(
            services.income_for_month(self.user, self.month), Decimal("0.00")
        )
    ...
    def test_income_flows_into_ready_to_assign(self):
        ...
        self.assertEqual(
            services.to_be_assigned(self.user, self.month), Decimal("1000.00")
        )
